            ...
            <article className="max-w-3xl mx-auto px-6 py-12 md:py-16 animate-fade-in">
                ...
                <header className="mb-10 animate-fade-up">
                    <div className="flex items-center gap-3 mb-4 flex-wrap">
                        ...
                        <span className="text-warm-300">·</span>
                        <span className="font-heading text-sm text-ink-muted tracking-wide flex items-center gap-1">
                    ...
                    <h1 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold text-ink leading-tight heading-glow">
                        {story.title}
                    </h1>
